...
{
    lecteur     = document.querySelector(selecteurLecteur);
    curseur     = document.querySelector(selecteurCurseur);
    progression = document.querySelector(selecteurProgression);
    btnPlay     = document.querySelector(selecteurBtnPlay);
    temps       = document.querySelector(selecteurTemps);
}
